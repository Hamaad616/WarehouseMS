...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="container">
                <div class="well">
                    <div class="row">
                        <div class=" col-lg-12 col-md-12 col-sm-12"> <a>GRN number : <span
                                    class="badge badge-info">{{ $grn_id }}</span></a><br><br> <br> </div>
                    </div>
                        ...
                        <div class=" col-lg-12 col-md-12 col-sm-12">
                            <form action="{{ route('grn.create') }}" method="POST" id="add_name">
                                ...
                                <div class="table-responsive">
                                    <input type="hidden" name="client_id" id="client_id" value="{{ $sch_id }}">
                                    <table class="table table-responsive">
                                        <tr>
                                            <td>
                                                ...
                                                <select type="text" class="form-control" name="sch_id" id="sch_id"
                                                    ...
                                                    @foreach ($users2 as $user2)
                                                        <option value="{{ $user2->sch_id }}">{{ $user2->sch_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                ...
                                                <select type="text" class="form-control" id="session_id "
                                                    name="session_id">
                                            ...
                                            <td>
                                                ...
                                                <select type="text" class="form-control" name="v_id" id="v_id"
                                                    tabindex="2" required>
                                                    <option value="">Select vendor</option>
                                                    @foreach ($users1 as $user1)
                                                        <option value="{{ $user1->id }}">{{ $user1->vend_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                ...
                                                <input class="form-control" name="do" required="required" id="do"
                                                    tabindex="3">
                                                <input class="form-control" name="grn_id" required type="hidden"
                                                    value="{{ $grn_id }}">
                                                <input class="form-control" name="func" required type="hidden"
                                                    value="add">
                                            </td>
                                            <td>
                                            ...
                                            <td> <label class="control-label " for="">Delivery Date</label>
                                                <input type="date" name="todate" id="todate" min="1000-01-01"
                                                    max="3000-12-31" class="form-control" value="">
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="mydiv table-responsive">
                                        <table class="table" id="dynamic_field">
                                            ...
                                            <tr>
                                                <td style=" width: 2%; "><span class="badge badge-info"
                                                        style=" margin-top:35px;">1</span></td>
                                                <td>
                                                    <label class="control-label " for="">Product
                                                        barcode</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                                        id="span_1"></span>
                                                    <input class="form-control name_list code" name="code[]" id="code1"
                                                        required placeholder="Enter Product Code" onblur="check_code(1);">

                                                </td>
                                                <td>
                                                    <label class="control-label " for="">Quantity</label>
                                                    <input class="form-control name_list quantity" name="quantity[]"
                                                        required type="number" id="quantity1"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                <td></td>
                                                <td></td>
                                                <td style=" width: 6.5%"><button type="button" name="add" id="add"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                $('#dynamic_field').append('<tr  id="row' + i +
                    '"><td style=" width: 2%"><span class="badge badge-info">' + i +
                    '</span></td><td>Product Barcode&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id=span_' +
                    i + '> </span><input type="text" required name="code[]" id="code' + i +
                    '"  placeholder="Enter Product Code" class="form-control name_list code " onblur=" check_code(' +
                    i + ');" value=""/></td><td style="margin-top:10px"><span id=span_' + i +
                    '>Quantity</span><input type="text" required name="quantity[]"  id="quantity' + i +
                    '" type="number"  placeholder="Enter  Product Quantity" class="quantity  form-control name_list search" /></td><td><button type="button" name="remove" id="' +
                    i +
        ...
        function check_code(val) {
            // var pitem_code  = document.getElementById('code'+val+'').value;
            ...
            $.get('<?= url('check_code') ?>', {
                ...
                if (data.code == 0) {
                    ...
                    $('#code' + val + '').siblings("span").text('Product Not Available at the time').addClass(
                        'text-danger');
                    ...
                    $('#code' + val + '').siblings("span").text(data.details).removeClass('text-danger').addClass(
                        'text-success');
            ...
            //             $('#code'+val+'').parent().removeClass();
            //             $('#code'+val+'').parent().addClass("form_error");
            //             $('#code'+val+'').siblings("span").text(response);
