...
@section('content')
    ...
    <div class="card">
        ...
        <h3 class="card-header">Edit Client Items</h3>
                                    ...
                                    <div class="row" style="margin-left:25px;">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="code" value="{{ $item->item_code }}" required=""
                                    ...
                                    <div class="row" style="margin-left:25px;">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="name" value="{{ $item->item_name }}" required=""
                                                    spellcheck="false" data-ms-editor="true">
                                                <input class="form-control" type="hidden" name="item_id" value="{{ $item->item_id }}">
                                                <input class="form-control" name="sch_id" value="{{ $sch_id }}" type="hidden">
                                            </div>
