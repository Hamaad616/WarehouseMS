                                    ...
                                    <div class="row" style="margin-left:25px;">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label class="control-label " for="category_barcode">Barcode</label>
                                                <input class="form-control" name="category_barcode"
                                                    value="{{ $item->category_barcode }}" required="" spellcheck="false"
                                                    data-ms-editor="true">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="category_name" type="text"
                                                    ...
                                                    <input class="form-control" name="category_type" type="hidden"
                                        ...
                                        <div class="col-md-8">
                                            <div align="end">
                                                <button type="button" class="btn btn-danger"
                                                    onclick="javascript:window.history.back() = 'stock_item';">Cancel</button>
