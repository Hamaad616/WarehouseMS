            ...
            <div class="box-controls pull-right">
                <div class="btn-group ms-10">
                    <button class="btn btn-xs btn-primary-light dropdown-toggle" type="button"
                        data-bs-toggle="dropdown">Show All</button>
                    ...
                    <div class="row g-0 row-cols-auto">
                        <div class="col">
                            <div class="section-bx">
                                <a href="#" class="w-40 h-40 m-5 bg-secondary d-block rounded10">
                                    <div class="bx-dec">
                                        <div class="section-dec d-flex align-items-center">
                                            <div class="box-img">
                                                <img src="{{ asset('img/box.png') }}" class="img-fluid" alt="">
                                            </div>
                                            <div class="dec">
                                ...
                                <a href="#" class="w-40 h-40 m-5 bg-warning-light d-block rounded10">
                                    <div class="bx-dec">
                                        <div class="section-dec d-flex align-items-center">
                                            ...
                                            <div class="dec">
                                                <h4 class="text-white my-0">Emtpy</h4>
                                            </div>
                                        </div>
                                    </div>
                                </a>
