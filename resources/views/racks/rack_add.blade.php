...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css">
    ...
    <div class="card">
        <h3 class="card-header">{{ $wh_name }} <small>racks</small> </h3>
        <div class="card-body">
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-8" style="margin-top:20px;">
                    <div class="well">
                        <form action="{{ route('rack.create', $wh_id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <div class="col-lg-8 col-lg-offset-2">
                                    <input type="hidden" name="wh_id" id="wh_id" value="{{ $wh_id }}">
                                    <input type="hidden" name="wh_code" id="wh_code" value="{{ $wh_code }}">
                                    <input type="hidden" name="wh_name" id="wh_name" value="{{ $wh_name }}">
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-left:25px;">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="rk_location" required
                            ...
                            <div class="row" style="margin-left:25px;">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="rk_code" placeholder='Enter Rack Code' required
                                            autocomplete="off">
                                    </div>
                            ...
                            <div class="row" style="margin-left:25px;">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="row_name" placeholder="Enter Row Name" required
                            ...
                            <!--                                <div class="row" style="margin-left:25px;" >
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"  name="pallet" placeholder="Enter Pallet"required>
                                                </div>
                            ...
                            <div class="row" style="margin-left:25px;">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="width" placeholder="Enter Width" required
                                            onkeypress="return /[0-9]/g.test(event.key)" autocomplete="off">
                                    </div>
                            ...
                            <div class="row" style="margin-left:25px;">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="height" placeholder="Enter height" required
                                            onkeypress="return /[0-9]/g.test(event.key)" autocomplete="off">
                                    </div>
                            ...
                            <div class="row" style="margin-left:25px;">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="depth" placeholder="Enter depth" required
                                            onkeypress="return /[0-9]/g.test(event.key)" autocomplete="off">
                                    </div>
