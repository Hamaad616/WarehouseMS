...
@section('content')
    ...
    <div class="card">
        ...
        <h3 class="card-header">Categories <a style="float: right;" href="{{ url('category-create-view') }}"
                class="btn btn-lg"><i class="bi bi-plus-square"></i></a></h3>
                    ...
                    <thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="8%">
                                    <div class="btn-group">
                                        <a href="{{ route('category.edit', ['category_id' => $item->id]) }}" class="btn btn-success"><i class="bi bi-pencil-fill"></i></a>
                                        <a href="{{ route('category.delete', ['category_id' => $item->id]) }}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
